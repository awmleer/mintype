...
<!-- 评论区域代码结束 -->
			...
			<form method="post" action="<?php $this->commentUrl() ?>" id="comment_form">
                ...
                <?php endif; ?>
				<p><textarea rows="3" name="text" placeholder="Stay Before Every Beautiful Thoughts..."><?php $this->remember('text'); ?></textarea></p>
				<botton><button type="submit" value="<?php //_e('提交评论'); ?>" class="btn btn-primary" />Post It</botton>
			</form>
            </div>
            <?php else: ?>
            <h4><?php _e(''); ?></h4>
